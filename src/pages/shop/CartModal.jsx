...
//         <div className={`fixed right-0 top-0 md:w-1/3 w-full bg-white h-full overflow-auto
...
//                     <i className="ri-xrp-line bg-black p-1 text-white">
//                     </i></button>
//                    </div>
...
//                         <button
//                         className='size-6 flex items-center justify-center px-1.5 rounded-full bg-gray-200
...
//               products.map((item, index) => (
//                 <div
//                   key={item._id || item.id || index} // Use a unique key
